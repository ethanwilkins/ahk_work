...
#IfWinNotExist, `%A_WorkingDir`%\ETemplates.ahk
{
  Run, %A_WorkingDir%\ETemplates.ahk
}
...
ExitFunc()
{
  ...
  WinClose, %A_WorkingDir%\ETemplates.ahk ahk_class AutoHotkey
}
...
File Path: C:\Users\<USERNAME>\Desktop\Temp AHK\
*/
;----------------------------------- HOTSTRINGS ---------------------------------------------------------------------------------------------------------

::lmk::Please let me know if you have any questions.
::tfyr::Thank you for your reply.
::tfcu::Thank you for contacting us.
;----------------------------------- LINKS AND URLS -------------------------------------------------------------------------------------------------------------
...
;----------------------------------- INTRODUCTIONS-------------------------------------------------------------------------------------------------------------
::xintro::My name is Forrest and I will be assisting Evan during this upcoming school year.
...
GETTING STARTED TOOLKIT FOR ADMINISTRATORS
Need help getting started? We've created a toolkit of resources to help you, as administrator, get your school set up using IXL.
    - Administrator Quick-start Guide - https://www.ixl.com/userguides/IXLQuickStart_Administrator.pdf - The illustrated guide provide step-by-step instructions for how to manage student accounts and run school-wide reports.
    - Frequently Asked Questions - https://www.ixl.com/help-center/School-administrators/665924 - Need more help? IXL's Help Center offers answers to common questions.
...
New teachers have been sent their sign-in information. Once signed in, teachers can view their students' usernames and passwords on their rosters. You can also view students' sign-in information through the master roster in your admin account.
